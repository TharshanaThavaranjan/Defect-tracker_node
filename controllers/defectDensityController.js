const defectDensityService = require('../services/defectDensityService');

class DefectDensityController {
  async getDefectDensity(req, res) {
    try {
      const { projectId } = req.params;
      const result = await defectDensityService.getDefectDensity(projectId);
...
module.exports = new DefectDensityController();
